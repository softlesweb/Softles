...
const PREFILL =
  "Hi SoftLes, I want to talk to a WordPress expert about my website.";

export default function WhatsappButton({ className = "", children }) {
  ...
  return (
    <a
      ...
      onClick={() => {
        ...
        trackEvent("contact", { method: "whatsapp", source: "wordpress_lp" });
      }}
