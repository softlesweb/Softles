...
function MemberCard({ member }) {
  return (
    <article className="group softles-card overflow-hidden w-[220px] sm:w-[240px] shrink-0">
      <div className="relative aspect-[4/5] overflow-hidden bg-gradient-to-br from-surface-raised to-[#12161F]">
        {member.image ? (
          <Image
            src={member.image}
            alt={member.name}
        ...
        {member.linkedin && (
          <a
            ...
            className="absolute top-3 right-3 flex h-8 w-8 items-center justify-center rounded-lg bg-surface/80 border border-line text-ink-muted backdrop-blur-md transition-all hover:bg-brand hover:border-brand hover:text-white opacity-0 group-hover:opacity-100 focus-visible:opacity-100"
          >
      ...
      <div className="p-4 text-center">
        ...
        <p className="text-xs sm:text-sm text-ink-muted/80 mt-1">{member.role}</p>
      </div>
    </article>
  );
}
  ...
  return (
    <section id="about" className="softles-section-primary overflow-hidden">
      <div className="service-page-container">
        ...
        <h2 className="service-section-heading text-ink">The people behind SoftLes</h2>
      ...
      <div className="mt-10 relative overflow-hidden before:absolute before:left-0 before:top-0 before:bottom-0 before:w-16 sm:before:w-28 before:bg-gradient-to-r before:from-surface before:to-transparent before:z-10 after:absolute after:right-0 after:top-0 after:bottom-0 after:w-16 sm:after:w-28 after:bg-gradient-to-l after:from-surface after:to-transparent after:z-10">
