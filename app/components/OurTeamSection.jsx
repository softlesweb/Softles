...
function MemberCard({ member }) {
  return (
    <article className="group softles-card overflow-hidden w-[220px] sm:w-[240px] shrink-0">
      <div className="relative aspect-[4/5] overflow-hidden bg-surface-overlay">
        {member.image ? (
          <Image
            src={member.image}
            alt={member.name}
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <span className="flex h-20 w-20 items-center justify-center rounded-full bg-surface-raised border border-line-strong text-2xl font-semibold text-ink-faint">
        ...
        {member.linkedin && (
          <a
            ...
            className="absolute top-3 right-3 flex h-8 w-8 items-center justify-center rounded-lg bg-surface/80 border border-line text-ink-faint backdrop-blur-md transition-all hover:border-brand hover:text-brand opacity-0 group-hover:opacity-100 focus-visible:opacity-100"
          >
      ...
      <div className="p-5 text-center">
        <h3 className="text-sm sm:text-base font-semibold text-ink leading-tight">{member.name}</h3>
        <p className="text-ink-faint text-sm mt-1 leading-relaxed">{member.role}</p>
      </div>
    </article>
  );
}
  ...
  return (
    <section id="about" className="softles-section-primary overflow-hidden">
      <div className="service-page-container">
        ...
        <h2 className="service-section-heading font-semibold text-ink">The people behind SoftLes</h2>
      ...
      <div className="mt-12 md:mt-16 relative overflow-hidden before:absolute before:left-0 before:top-0 before:bottom-0 before:w-16 sm:before:w-28 before:bg-gradient-to-r before:from-surface before:to-transparent before:z-10 after:absolute after:right-0 after:top-0 after:bottom-0 after:w-16 sm:after:w-28 after:bg-gradient-to-l after:from-surface after:to-transparent after:z-10">
